"""
241108 added, Yu Hamakawa.
Processing of APTCs dataset.
"""
...
def get_default_aptc_task_names():
    """Get that default freesolv task names and return measured expt"""
    return ['ACTIVITY']


def load_aptc_dataset(data_path, task_names=None, test_mode=False):
    """
    tbd
    """
    if task_names is None:
        task_names = get_default_aptc_task_names()
...
def get_aptc_stat(data_path, task_names, test_mode=False):
